  ...
  var app = new Vue({
    ...
    mounted() {
      ...
      if (this.config.wsEndpoint) {
        ...
        ws.onmessage = evt => {
          var _data$player, _data$map$name, _data$map, _data$player2, _data$player3;
          ...
          this.modeName = this.config.validKzModes.includes(data === null || data === void 0 ? void 0 : (_data$player2 = data.player) === null || _data$player2 === void 0 ? void 0 : _data$player2.clan) ? data === null || data === void 0 ? void 0 : (_data$player3 = data.player) === null || _data$player3 === void 0 ? void 0 : _data$player3.clan : config__default['default'].defaultModeName;
        };
      }
    },
    ...
    methods: {
      ...
      fetchData: function () {
        var _fetchData = _asyncToGenerator(function* () {
          ...
          if (!((_this$map = this.map) === null || _this$map === void 0 ? void 0 : _this$map.validated)) {
            this.tpWr = null;
            this.tpPb = null;
            this.proWr = null;
            this.proPb = null;
